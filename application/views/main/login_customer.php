...
<head>
    ...
    <title>E-Commerce Adidas | Login Customer</title>
    <!-- Favicon icon -->
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                <h4>Login</h4>
                                <form class="mt-5 mb-5 login-input" action="<?= base_url()?>login/validasicust" method="POST">
                                ...
                                <p class="mt-5 login-form__footer">Dont have account? <a href="<?= base_url()?>login/registrasi" class="text-primary">Sign Up</a> now</p>
                            </div>
                        </div>
                    </div>
                </div>
