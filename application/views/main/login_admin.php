...
<head>
    ...
    <title>E-Commerce Adidas | Login Admin</title>
    <!-- Favicon icon -->
                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                <a class="text-center" href="index.html"> <h4>Login Admin</h4></a>
        
                                <form class="mt-5 mb-5 login-input" action="<?= base_url()?>login/validasiadmin" method="POST">
